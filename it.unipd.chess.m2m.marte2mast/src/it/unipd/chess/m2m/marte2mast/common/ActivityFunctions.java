...
//	}
	...
	public static String getSimpleOperationText(NamedElement theElement) {
		...
		if (!HelperFunctions.getStereotypeRefListNames(theElement, "SaStep","sharedRes").toString().equals("")){
			Package packagePSM = theElement.getNearestPackage().getNestingPackage();
			boolean isRUN = HelperFunctions.isRUNSystem(packagePSM);
			...
			if(!isRUN || Config.USE_SHARED_RESOURCES_FOR_RUN)
				outputText += content;
			else 
				outputText += commentedContent;
		}
	...
	public static String getExternalEventText(Element elt) {
		...
		//----------------------------- PERIODIC ----------------
			...
			if(HelperFunctions.getStereotypeProperty(elt,"GaWorkloadEvent","pattern")!=null){
				...
				String phase = HelperFunctions.parseNFP_Duration(HelperFunctions.parseSchedParams((String) HelperFunctions.getStereotypeProperty(elt,"GaWorkloadEvent","pattern"),"periodic","phase"),"value");
				if (phase != null && !phase.equals("") && !phase.equals("MALFORMED INPUT"))
					outputText +=",\n         Phase 	=> "+ HelperFunctions.parseNFP_Duration(HelperFunctions.parseSchedParams((String) HelperFunctions.getStereotypeProperty(elt,"GaWorkloadEvent","pattern"),"periodic","phase"),"value")  +")";
				else
					outputText +=")";
