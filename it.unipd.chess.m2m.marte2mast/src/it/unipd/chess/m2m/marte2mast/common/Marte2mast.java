...
public class Marte2mast extends AbstractAcceleoGenerator {
	...
	public static String mOutputXMLFile;
	public static String mInputMastFile;
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/it/unipd/chess/m2m/marte2mast/common/marte2mast";
    ...
    public Marte2mast(URI modelURI, File targetFolder,
        ...
        mInputMastFile = mTargetFolder.toString() + System.getProperty("file.separator") + HelperFunctions.uriToFileName(mModelURI);//.lastSegment().replace(".uml", ".mast");
        mOutputXMLFile = mInputMastFile + ".xml";
    }
