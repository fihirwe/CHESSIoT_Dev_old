...
public class DependableComponentFactoryImpl extends EFactoryImpl implements DependableComponentFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case DependableComponentPackage.ANALYSIS_CONTEXT_ELEMENT: return createAnalysisContextElement();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case DependableComponentPackage.ANALYSIS:
				return createAnalysisFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case DependableComponentPackage.ANALYSIS:
				return convertAnalysisToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public Analysis createAnalysisFromString(EDataType eDataType, String initialValue) {
		Analysis result = Analysis.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertAnalysisToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	...
	public AnalysisContextElement createAnalysisContextElement() {
		AnalysisContextElementImpl analysisContextElement = new AnalysisContextElementImpl();
		return analysisContextElement;
	}
