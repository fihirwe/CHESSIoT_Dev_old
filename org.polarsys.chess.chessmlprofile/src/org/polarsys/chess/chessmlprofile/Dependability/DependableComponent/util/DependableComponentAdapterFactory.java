...
public class DependableComponentAdapterFactory extends AdapterFactoryImpl {
	...
	protected DependableComponentSwitch<Adapter> modelSwitch =
		new DependableComponentSwitch<Adapter>() {
			...
			@Override
			public Adapter caseAnalysisContextElement(AnalysisContextElement object) {
				return createAnalysisContextElementAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.chess.chessmlprofile.Dependability.DependableComponent.AnalysisContextElement <em>Analysis Context Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
