...
public class ExpressionsFactoryImpl extends EFactoryImpl implements ExpressionsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ExpressionsPackage.MACRO_DEFINITION: return createMacroDefinition();
			case ExpressionsPackage.PARAMETER_ASSUMPTIONS: return createParameterAssumptions();
			default:
	...
	public ParameterAssumptions createParameterAssumptions() {
		ParameterAssumptionsImpl parameterAssumptions = new ParameterAssumptionsImpl();
