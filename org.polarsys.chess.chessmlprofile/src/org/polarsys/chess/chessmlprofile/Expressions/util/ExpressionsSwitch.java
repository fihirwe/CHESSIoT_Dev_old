...
public class ExpressionsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExpressionsPackage.MACRO_DEFINITION: {
			...
			case ExpressionsPackage.PARAMETER_ASSUMPTIONS: {
				ParameterAssumptions parameterAssumptions = (ParameterAssumptions)theEObject;
				T result = caseParameterAssumptions(parameterAssumptions);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Parameter Assumptions</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Parameter Assumptions</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseParameterAssumptions(ParameterAssumptions object) {
		return null;
	}
