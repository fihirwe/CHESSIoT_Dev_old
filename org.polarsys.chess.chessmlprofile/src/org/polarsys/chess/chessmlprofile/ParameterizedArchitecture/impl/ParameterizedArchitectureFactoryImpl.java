...
public class ParameterizedArchitectureFactoryImpl extends EFactoryImpl implements ParameterizedArchitectureFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ParameterizedArchitecturePackage.INSTANTIATED_ARCHITECTURE_CONFIGURATION: return createInstantiatedArchitectureConfiguration();
			default:
	 ...
	 * @generated
	 */
	public InstantiatedArchitectureConfiguration createInstantiatedArchitectureConfiguration() {
		InstantiatedArchitectureConfigurationImpl instantiatedArchitectureConfiguration = new InstantiatedArchitectureConfigurationImpl();
		return instantiatedArchitectureConfiguration;
	}
