...
public class ParameterizedArchitecturePackageImpl extends EPackageImpl implements ParameterizedArchitecturePackage {
	 ...
	 * @generated
	 */
	private EClass instantiatedArchitectureConfigurationEClass = null;
	/**
	 ...
	 * @generated
	 */
	public EClass getInstantiatedArchitectureConfiguration() {
		return instantiatedArchitectureConfigurationEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getInstantiatedArchitectureConfiguration_ParameterList() {
		return (EAttribute)instantiatedArchitectureConfigurationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getInstantiatedArchitectureConfiguration_Base_Property() {
		return (EReference)instantiatedArchitectureConfigurationEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getInstantiatedArchitectureConfiguration_InstantiatedRootComponent() {
		return (EReference)instantiatedArchitectureConfigurationEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		instantiatedArchitectureConfigurationEClass = createEClass(INSTANTIATED_ARCHITECTURE_CONFIGURATION);
		createEAttribute(instantiatedArchitectureConfigurationEClass, INSTANTIATED_ARCHITECTURE_CONFIGURATION__PARAMETER_LIST);
		createEReference(instantiatedArchitectureConfigurationEClass, INSTANTIATED_ARCHITECTURE_CONFIGURATION__BASE_PROPERTY);
		createEReference(instantiatedArchitectureConfigurationEClass, INSTANTIATED_ARCHITECTURE_CONFIGURATION__INSTANTIATED_ROOT_COMPONENT);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(instantiatedArchitectureConfigurationEClass, InstantiatedArchitectureConfiguration.class, "InstantiatedArchitectureConfiguration", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getInstantiatedArchitectureConfiguration_ParameterList(), theTypesPackage.getString(), "ParameterList", null, 0, -1, InstantiatedArchitectureConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getInstantiatedArchitectureConfiguration_Base_Property(), theUMLPackage.getProperty(), null, "base_Property", null, 1, 1, InstantiatedArchitectureConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
