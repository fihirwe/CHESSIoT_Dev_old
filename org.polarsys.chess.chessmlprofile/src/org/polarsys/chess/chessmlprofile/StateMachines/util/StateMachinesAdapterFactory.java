...
public class StateMachinesAdapterFactory extends AdapterFactoryImpl {
	...
	protected StateMachinesSwitch<Adapter> modelSwitch =
		new StateMachinesSwitch<Adapter>() {
			@Override
			public Adapter casePrioritizedTransition(PrioritizedTransition object) {
				return createPrioritizedTransitionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.chess.chessmlprofile.StateMachines.PrioritizedTransition <em>Prioritized Transition</em>}'.
	 * <!-- begin-user-doc -->
