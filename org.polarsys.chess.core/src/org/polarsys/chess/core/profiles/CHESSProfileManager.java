...
public class CHESSProfileManager {
	...
	public static final String IoT_VIEW = "IoTView";
	...
	static {
		...
		CONCURRENT_VIEWS.add(IoT_VIEW);
		CONCURRENT_VIEWS.add(SYSTEM_VIEW);
	}
	...
	static {
		...
		CONCURRENT_VIEWS_COMPONENT.add(IoT_VIEW);
	}
	
	public static final ArrayList<String> CONCURRENT_VIEWS_SYSTEM = new ArrayList<String>();
	static {
		CONCURRENT_VIEWS_SYSTEM.add(IoT_VIEW);
		CONCURRENT_VIEWS_SYSTEM.add(SYSTEM_VIEW);
	}
	...
	static {
		...
		CONCURRENT_VIEWS_DEPLOYMENT.add(IoT_VIEW);
	}
	...
	static {
		...
		CONCURRENT_VIEWS_ASSOCIATION.put(SYSTEM_VIEW,
				CONCURRENT_VIEWS_SYSTEM);
	}
...
//		ApplyCHESSIoTProfile a= new ApplyCHESSIoTProfile();
//				a.addProfile(model, null);
