...
public class SelectionListenerManager extends SelectionListenerExtra{
	...
	public void selectionChanged(IWorkbenchPart part, ISelection selection) {
		Enumeration<SelectionListenerExtra> registeredListeners = listenerRegistry.elements();
		while(registeredListeners.hasMoreElements()) {
			SelectionListenerExtra listener = registeredListeners.nextElement();
