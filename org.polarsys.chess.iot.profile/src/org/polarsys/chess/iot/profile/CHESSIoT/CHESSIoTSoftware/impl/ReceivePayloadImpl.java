 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.chess.iot.profile.CHESSIoT.CHESSIoTSoftware.impl.ReceivePayloadImpl#getBase_Operation <em>Base Operation</em>}</li>
 *   <li>{@link org.polarsys.chess.iot.profile.CHESSIoT.CHESSIoTSoftware.impl.ReceivePayloadImpl#getPayload <em>Payload</em>}</li>
 *   <li>{@link org.polarsys.chess.iot.profile.CHESSIoT.CHESSIoTSoftware.impl.ReceivePayloadImpl#getBase_Event <em>Base Event</em>}</li>
 *   <li>{@link org.polarsys.chess.iot.profile.CHESSIoT.CHESSIoTSoftware.impl.ReceivePayloadImpl#getBase_Action <em>Base Action</em>}</li>
...
public class ReceivePayloadImpl extends IoTActionImpl implements ReceivePayload {
		...
		if (base_Operation != null && base_Operation.eIsProxy()) {
			...
			if (base_Operation != oldBase_Operation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CHESSIoTSoftwarePackage.RECEIVE_PAYLOAD__BASE_OPERATION, oldBase_Operation, base_Operation));
			}
		}
	...
	public void setBase_Operation(Operation newBase_Operation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSIoTSoftwarePackage.RECEIVE_PAYLOAD__BASE_OPERATION, oldBase_Operation, base_Operation));
	}
	...
	public Event getBase_Event() {
		if (base_Event != null && base_Event.eIsProxy()) {
			...
			if (base_Event != oldBase_Event) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CHESSIoTSoftwarePackage.RECEIVE_PAYLOAD__BASE_EVENT, oldBase_Event, base_Event));
			}
		}
		return base_Event;
	}
	...
	public void setBase_Event(Event newBase_Event) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSIoTSoftwarePackage.RECEIVE_PAYLOAD__BASE_EVENT, oldBase_Event, base_Event));
	}
	...
	public Action getBase_Action() {
		if (base_Action != null && base_Action.eIsProxy()) {
			...
			if (base_Action != oldBase_Action) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CHESSIoTSoftwarePackage.RECEIVE_PAYLOAD__BASE_ACTION, oldBase_Action, base_Action));
			}
		}
		return base_Action;
	}
	...
	public void setBase_Action(Action newBase_Action) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSIoTSoftwarePackage.RECEIVE_PAYLOAD__BASE_ACTION, oldBase_Action, base_Action));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CHESSIoTSoftwarePackage.RECEIVE_PAYLOAD__BASE_OPERATION:
				if (resolve) return getBase_Operation();
				return basicGetBase_Operation();
			case CHESSIoTSoftwarePackage.RECEIVE_PAYLOAD__PAYLOAD:
				return getPayload();
			case CHESSIoTSoftwarePackage.RECEIVE_PAYLOAD__BASE_EVENT:
				if (resolve) return getBase_Event();
				return basicGetBase_Event();
			case CHESSIoTSoftwarePackage.RECEIVE_PAYLOAD__BASE_ACTION:
