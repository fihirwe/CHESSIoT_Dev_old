...
public class CompareSchedResultDialog extends Dialog {
	...
	/** The analysis context name 1. */
	private String analysisContextName1;
	
	/** The analysis context name 2. */
	...
	/**
	 * Instantiates a new compare sched result dialog.
	 *
	 * @param parentShell the parent shell
	 * @param analysisContextName1 the analysis context name 1
	 * @param analysisContextName2 the analysis context name 2
	 * @param analysisResData1 the analysis res data 1
	 * @param analysisResData2 the analysis res data 2
