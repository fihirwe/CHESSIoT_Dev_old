...
public class SchedResultDialog extends Dialog {
	...
	/** The analysis res data. */
	private List<AnalysisResultData> analysisResData;

	/**
	 * Instantiates a new sched result dialog.
	 *
	 * @param parentShell the parent shell
	 * @param result the result
	 * @param analysisResData the analysis res data
	 * @param hwResults the hw results
	 */
